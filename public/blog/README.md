# 블로그 폴더 설명 (agd.dongbaektour.co.kr)
...
주소는 `https://agd.dongbaektour.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://agd.dongbaektour.co.kr/blog/agoda-coupon/ |
